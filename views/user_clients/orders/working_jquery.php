...
<script type="text/javascript">
  ...
  $(document).ready(function() {
    $("#customer_name").keyup(function(){
		  $.ajax({
		    type: "POST",
		    url: base_url + "application/views/orders/readCountry.php",
		    data:'keyword='+$(this).val(),
		    beforeSend: function(){
			    $("#customer_name").css("background","#FFF url(base_url + 'application/views/orders/LoaderIcon.gif') no-repeat 165px");
		    },
